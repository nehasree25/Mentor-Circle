    ...
    <div className="space-y-6">
      ...
      <div className="rounded-2xl border border-borderline bg-white p-6 shadow-soft">
        ...
        <div className="space-y-4">
          ...
          <div>
            <p className="text-sm text-textsecondary mb-2">LinkedIn Profile</p>
            {editing ? (
              <input
                type="url"
              ...
              <a
                ...
                className="text-royal hover:text-darkblue font-medium flex items-center gap-2"
              >
              ...
              <p className="text-textsecondary">Not provided</p>
            )}
          </div>
        </div>
      </div>
